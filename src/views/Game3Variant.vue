<template>
  <div class="game-container">
    <h1>Jeu des Chiffres (Variante)</h1>

    <div class="instructions">
      <p>Compte les fleurs et tape le chiffre correspondant</p>
    </div>
    ...
    <div class="number-rows">
      ...
      >
        ...
        >
          <!-- Only show the number after it has been validated -->
          <span v-if="index < currentNumberIndex">{{ number }}</span>
          <span v-else>?</span>
        </div>
        <div class="flowers">
          <span 
    ...
    <div v-if="gameCompleted" class="victory-message">
      <h2>Bravo !</h2>
      <p>Tu as réussi à compter toutes les fleurs et à trouver les bons chiffres !</p>
    ...
    handleKeyPress(event) {
      ...
      if (/^[0-9]$/.test(pressedKey)) {
        ...
        if (pressedKey === expectedNumber) {
          // Correct number - move to next number immediately
